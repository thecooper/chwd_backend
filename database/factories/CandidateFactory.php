...
$factory->define(\App\Models\Candidate\Candidate::class, function (Faker $faker) {
    return [
      'name' => $faker->name,
      'election_id' => null,
      ...
      'office_level' => randomElement(['State', 'Local', 'Federal']),
      'is_incumbent' => $faker->randomElement(['yes', 'no']),
